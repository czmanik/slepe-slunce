<article class="post-card">
    <a class="card-image" href="{{ route($post->category === \App\Models\Post::CATEGORY_TRAVEL ? 'guides.show' : 'posts.show', $post) }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="card-body">
        ...
        <h3><a href="{{ route($post->category === \App\Models\Post::CATEGORY_TRAVEL ? 'guides.show' : 'posts.show', $post) }}">{{ $post->title }}</a></h3>
        <p>{{ $post->excerpt }}</p>
